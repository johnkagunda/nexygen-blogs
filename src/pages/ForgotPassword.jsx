      ...
      <section className='mx-auto max-w-7xl'>
        <div className='g-6 flex h-full flex-wrap items-center justify-center lg:justify-between'>
          <div className='shrink-1 mb-12 grow-0 basis-auto rounded-md bg-[#003f5c] md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12'>
            <img src='https://tecdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp' className='w-full' alt='Sample' />
          </div>
            ...
            <form onSubmit={passwordResetEmail}>
              ...
              <div className='mx-auto flex w-full max-w-[90%] items-center justify-between'>
                <p className='text- pt-3 text-gray-400'>
                  Have an account?
                  <span onClick={() => navigate("/sign-in")} className='cursor-pointer bg-gradient-to-r from-rose-400 to-red-500 bg-clip-text text-transparent'>
                    Login
                  </span>
                </p>
                <p onClick={() => navigate("/sign-up")} className='inline cursor-pointer bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text pt-3 text-transparent hover:shadow-xl'>
                  Register
                </p>
              </div>

              <div className='mx-auto my-8 w-full max-w-[70%]'>
                <button type='submit' className='w-full cursor-pointer rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 py-3 font-semibold text-white transition duration-200 ease-in-out active:scale-90'>
                  Send reset email
                </button>
              </div>
